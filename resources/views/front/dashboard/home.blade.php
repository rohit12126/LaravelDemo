                    ...
                    <div class="col-md-6 col-sm-12">
                         <div class="home-video">
                              <div class="embed-responsive embed-responsive-16by9">
                               <iframe src="https://www.youtube.com/embed/EMwdIXvntq8" frameborder="0" allowfullscreen></iframe>
                              </div>
                         </div>
                    </div>
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="blog-detail.html"><img src="{{ url('frontend') }}/images/blog-image1.jpg" class="img-responsive" alt=""></a>
                              </div>
                              <div class="media-body blog-info">
                                   <small><i class="fa fa-clock-o"></i> December 22, 2017</small>
                                   <h3><a href="#">How To Find Out Beautiful Workspace.</a></h3>
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="#"><img src="{{ url('frontend') }}/images/blog-image2.jpg" class="img-responsive" alt=""></a>
                              </div>
                              <div class="media-body blog-info">
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="#"><img src="{{ url('frontend') }}/images/blog-image3.jpg" class="img-responsive" alt=""></a>
                              </div>
                              <div class="media-body blog-info">
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="media blog-thumb">
                              <div class="media-object media-left">
                                   <a href="#"><img src="{{ url('frontend') }}/images/blog-image4.jpg" class="img-responsive" alt=""></a>
                              </div>
                              <div class="media-body blog-info">
               ...
               <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                         ...
                         <div class="work-thumb">
                              <a href="{{ url('frontend') }}/images/work-image1.jpg" class="image-popup">
                                   <img src="{{ url('frontend') }}/images/work-image1.jpg" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="{{ url('frontend') }}/images/work-image2.jpg" class="image-popup">
                                   <img src="{{ url('frontend') }}/images/work-image2.jpg" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="{{ url('frontend') }}/images/work-image3.jpg" class="image-popup">
                                   <img src="{{ url('frontend') }}/images/work-image3.jpg" class="img-responsive" alt="Work">
                    ...
                    <div class="col-md-3 col-sm-6">
                         <!-- WORK THUMB -->
                         <div class="work-thumb">
                              <a href="{{ url('frontend') }}/images/work-image4.jpg" class="image-popup">
                                   <img src="{{ url('frontend') }}/images/work-image4.jpg" class="img-responsive" alt="Work">
